import getSecrets from './modules/config';
...
document
  ...
  .addEventListener('submit', async (e) => {
    ...
    const username = sanitizeInput(
      document.getElementById('login-box-user-username-input').value,
    );
    const email = sanitizeInput(
      document.getElementById('login-box-user-email-input').value,
    );
    const password = sanitizeInput(
      document.getElementById('login-box-user-password-input').value,
    );
