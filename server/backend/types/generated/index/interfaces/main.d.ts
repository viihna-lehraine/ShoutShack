...
export declare const GetFeatureFlagsStaticParameters: {
    blankRequest: Request<import("express-serve-static-core").ParamsDictionary, any, any, import("qs").ParsedQs, Record<string, any>>;
};
...
export declare const AppLoggerServiceParameters: {
    winston: {
        createLogger: (options?: import("winston").LoggerOptions) => WinstonLogger;
