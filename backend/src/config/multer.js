...
const fileFilter = (req, file, cb) => {
    ...
    const allowedExtensions = [
        '.avi', '.json', '.gpg', '.asc', '.xml', '.mp4', '.mp3',
        '.ogg', '.wav', '.webm', '.bmp', '.jpeg', '.jpg', '.gif', '.png', '.svg', '.tiff', '.webp', '.html', '.css', '.csv', '.md', '.txt', '.mpeg', '.mov',  '.crt'
    ];
...
const multerConfiguredUpload = multer({
    storage: multer.diskStorage({ /* STORAGE OPTIONS */}),
