...
async function setupRoutes() {
	...
	router.get('/password-reset', (req, res) => {
		...
		res.sendFile(
			path.join(__dirname, '../../../frontend/public/password-reset.html')
		);
	...
	router.get('/privacy-policy', (req, res) => {
		...
		res.sendFile(
			path.join(__dirname, '../../../frontend/public/privacy-policy.html')
		);
	...
	router.get('/resources', (req, res) => {
		...
		res.sendFile(
			path.join(__dirname, '../../../frontend/public/resources.html')
		);
	...
	router.get('/security-acknowledgements', (req, res) => {
		...
		res.sendFile(
			path.join(
				__dirname,
				'../../../frontend/public/security-acknowledgements.html'
			)
		);
	...
	router.get('/security-policy', (req, res) => {
		...
		res.sendFile(
			path.join(__dirname, '../../../frontend/public/security-policy.html')
		);
	...
	router.get('/dashboard/security', (req, res) => {
		...
		res.sendFile(
			path.join(__dirname, '../../../frontend/public/dashboard/security.html')
		);
	...
	router.get('/dashboard/settings', (req, res) => {
		...
		res.sendFile(
			path.join(__dirname, '../../../frontend/public/dashboard/settings.html')
		);
	...
	router.use((req, res) => {
		res
			.status(404)
			.sendFile(
				path.join(__dirname, '../../../frontend/public/not-found.html')
			);
