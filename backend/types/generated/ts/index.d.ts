...
import loadEnv, { __dirname } from '../src/config/loadEnv';
import startServer from './config/http';
import { createTransporter, getTransporter } from '../src/config/mailer';
import multerConfiguredUpload from '../src/config/multer';
